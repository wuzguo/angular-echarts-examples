...
var Trace = (function () {
    ...
    Trace.prototype.traceHookInvocation = function (step, trans, options) {
        if (!this.enabled(exports.Category.HOOK))
            return;
        var tid = parse("transition.$id")(options), digest = this.approximateDigests, event = parse("traceData.hookType")(options) || "impl", context = parse("traceData.context.state.name")(options) || parse("traceData.context")(options) || "unknown", name = functionToString(step.registeredHook.callback);
...
var TargetState = (function () {
     ...
     * @param _definition The impl state representation, if exists.
    ...
    /** The impl state object (if it was found) */
    TargetState.prototype.$state = function () {
        return this._definition;
    };
    /** The impl state declaration (if it was found) */
    TargetState.prototype.state = function () {
...
var TransitionHook = (function () {
    ...
    TransitionHook.prototype.toString = function () {
        ...
        var event = parse("traceData.hookType")(options) || "impl", context = parse("traceData.context.state.name")(options) || parse("traceData.context")(options) || "unknown", name = fnToString(registeredHook.callback);
...
/**
 * An impl class which implements [[ParamTypeDefinition]].
 *
...
/**
 * @internalapi A impl global service
 *
 * StateBuilder is a factory for the impl [[State]] objects.
 *
 * When you register a state with the [[StateRegistry]], you register a plain old javascript object which
 * conforms to the [[StateDeclaration]] interface.  This factory takes that object and builds the corresponding
 * [[State]] object, which has an API and is used internally.
 *
 * Custom properties or API may be added to the impl [[State]] object by registering a decorator function
...
var StateRegistry = (function () {
     ...
     * Note: this returns the impl [[State]] representation, not a [[StateDeclaration]]
     *
...
var Transition = (function () {
     ...
     * @internalapi
     *
     * @returns the impl from [State] object
     */
     ...
     * @internalapi
     *
     * @returns the impl to [State] object
     */
...
var StateProvider = (function () {
     ...
     * properties within the state's impl definition. There is currently no clear
     * use-case for this beyond accessing impl states (i.e. $state.$current),
     ...
     * @example
     * <pre>
     * // Override the impl 'views' builder with a function that takes the state
     * // definition, and a reference to the impl function being overridden:
